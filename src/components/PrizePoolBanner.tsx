...
export const PrizePoolBanner = () => {
  return (
    <div className="w-full bg-gradient-to-r from-pirate-gold/20 via-pirate-gold/10 to-pirate-gold/20 border-y border-pirate-gold/10 fixed top-16 left-0 right-0 z-40">
